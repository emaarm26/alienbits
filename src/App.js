...
export const StyledButton = styled.button`
  ...
  width: 0px;
  cursor: pointer;
  box-shadow: 10px 10px 10px 10px rgba(250, 250, 250, 0.3);
  -webkit-box-shadow: 2px 2px 2px 2px rgba(250, 250, 250, 0.3);
...
export const StyledRoundButton = styled.button`
  ...
  -moz-box-shadow: 2px 2px 2px 2px rgba(250, 250, 250, 0.3);
  :active {
    box-shadow: none;
    -webkit-box-shadow: none;
    -moz-box-shadow: none;
            ...
            {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
              ...
              <>
                ...
                >
                  ...
                  Mint start September 17th  2022.
                </s.TextDescription>
                <s.SpacerSmall />
                {blockchain.account === "" ||
